        ...
        <div className='flex flex-col'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-10 gap-6'>
                {filteredWords.map((item) => (
                    ...
                    key={item.id} 
                    className='p-8 relative group flex flex-col gap-4 rounded-2xl border border-gray-200 shadow-sm  hover:border-orange-100 hover:shadow-2xl transition-all duration-300'>
                        <div className=''>
