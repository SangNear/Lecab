...
const ProgressReview = () => {
    return (
        <div className='flex items-center justify-center gap-2 border border-border rounded-full py-4 px-6 bg-card'>
            <p className='text-subtle text-[11px] font-bold uppercase tracking-wider whitespace-nowrap leading-none'>Tiến trình ôn tập</p>
